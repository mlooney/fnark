...
var _user$project$App$viewLink = function (link) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(link.blurb),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$App$viewLinks = function (ll) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$App$viewLink, ll));
};
var _user$project$App$viewAlert = function (a) {
	var _p0 = a;
	if (_p0.ctor === 'Nothing') {
...
var _user$project$App$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$App$viewAlert(model.alert),
			_1: {
				ctor: '::',
...
var _user$project$App$getLinks = A2(
	...
	A2(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(_user$project$App$linkDecoder))));
var _user$project$App$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$App$initialModel, _1: _user$project$App$getLinks},
